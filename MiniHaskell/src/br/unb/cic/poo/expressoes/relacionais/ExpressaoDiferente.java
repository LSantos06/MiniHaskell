 ...
 * @author LSantos06
 * 
 * Uma expressao diferente eh uma expressao binaria que 
 * realiza a comparacao entre dois valores, sendo eles inteiros ou booleanos,
 * e avalia se estes sao diferentes.
 */
public class ExpressaoDiferente extends ExpressaoBinaria{

	public ExpressaoDiferente(Expressao subExpressao1, Expressao subExpressao2) {
