...
/** CUP v0.10k generated parser.
  * @version Fri Jun 24 17:39:31 BRT 2016
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  public Parser.Absyn.Exp pExp() throws Exception
  {
	java_cup.runtime.Symbol res = parse();
	return (Parser.Absyn.Exp) res.value;
  }
      ...
      switch (CUP$parser$act_num)
        {
          ...
          case 8: // Exp2 ::= _SYMB_4 Exp _SYMB_5 
            {
              Parser.Absyn.Exp RESULT = null;
		Parser.Absyn.Exp p_2 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		 RESULT = p_2; 
		...
		Integer p_1 = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new Parser.Absyn.EInt(p_1); 
              CUP$parser$result = new java_cup.runtime.Symbol(3/*Exp2*/, RESULT);
            }
          return CUP$parser$result;
          ...
          case 6: // Exp1 ::= Exp2 
            {
              Parser.Absyn.Exp RESULT = null;
		Parser.Absyn.Exp p_1 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = p_1; 
          ...
          case 5: // Exp1 ::= Exp1 _SYMB_3 Exp2 
            {
              Parser.Absyn.Exp RESULT = null;
		Parser.Absyn.Exp p_1 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Parser.Absyn.Exp p_3 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new Parser.Absyn.EDiv(p_1,p_3); 
              CUP$parser$result = new java_cup.runtime.Symbol(2/*Exp1*/, RESULT);
            }
          return CUP$parser$result;
		...
		Parser.Absyn.Exp p_1 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Parser.Absyn.Exp p_3 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new Parser.Absyn.EMul(p_1,p_3); 
              CUP$parser$result = new java_cup.runtime.Symbol(2/*Exp1*/, RESULT);
            }
          return CUP$parser$result;
		...
		Parser.Absyn.Exp p_1 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Parser.Absyn.Exp p_3 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new Parser.Absyn.ESub(p_1,p_3); 
              CUP$parser$result = new java_cup.runtime.Symbol(1/*Exp*/, RESULT);
            }
          return CUP$parser$result;
		...
		Parser.Absyn.Exp p_1 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		Parser.Absyn.Exp p_3 = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 RESULT = new Parser.Absyn.EAdd(p_1,p_3); 
              CUP$parser$result = new java_cup.runtime.Symbol(1/*Exp*/, RESULT);
            }
          return CUP$parser$result;
          ...
          case 0: // $START ::= Exp EOF 
            {
              Object RESULT = null;
		Parser.Absyn.Exp start_val = (Parser.Absyn.Exp)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		RESULT = start_val;
